...
class Crawler
{
    ...
    public function __construct($id)
    {
        ...
        $this->feed = $simplepie->make($id); // The _id is the link of the feed
        $this->createChannel();
    }
    ...
    { 
        $this->channel = Channel::find($this->_id);
        if(!$this->channel) {
            $this->channel = new Channel();
            $this->channel->title = $feed->get_title();
            $this->channel->link = $feed->get_permalink();
            $this->channel->description = $feed->get_description();
            $this->channel->_id = $this->_id;
